  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        delivery_date_from: lastStop.date_from || null,
        delivery_date_to: lastStop.date_to || null,
        // Cargo & Vehicle
        ...
        pallets: form.pallet_count ? parseInt(form.pallet_count) : null,
        ...
        cargo_description: form.goods_description || null,
        // Pricing
